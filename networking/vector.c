...
extern void vector_init(vector_t* v, size_t elem_size, size_t init_size, void (*free_func)(void*))
{
...
extern void vector_dispose(vector_t* v)
{
	size_t i;
	if (v->free_func != NULL) {
...
extern void vector_copy(vector_t* v1, vector_t* v2)
{
...
extern void vector_insert(vector_t* v, void* elem, size_t index)
{
	void *target;
...
extern void vector_insert_at(vector_t* v, void* elem, size_t index)
{
	if ((int) index < 0)
		return;
...
extern void vector_push(vector_t* v, void* elem)
{
	vector_insert(v, elem, -1);
}

extern void vector_pop(vector_t* v, void* elem)
{
	memcpy(elem, VECTOR_INDEX(v->num_elems - 1), v->elem_size);
	v->num_elems--;
}

extern void vector_shift(vector_t* v, void* elem)
{
...
extern void vector_unshift(vector_t* v, void* elem)
{
	if (!VECTOR_HASSPACE(v))
...
extern void vector_transpose(vector_t* v, size_t index1, size_t index2)
{
	vector_swap(VECTOR_INDEX(index1), VECTOR_INDEX(index2), v->elem_size);
}

static void vector_grow(vector_t* v, size_t size)
{
...
extern void vector_get(vector_t* v, size_t index, void* elem)
{
	assert((int) index >= 0);
...
extern void vector_get_all(vector_t* v, void* elems)
{
	memcpy(elems, v->elems, v->num_elems * v->elem_size);
}

extern void vector_remove(vector_t* v, size_t index)
{
	if (!VECTOR_INBOUNDS(index))
		return;
...
extern void vector_remove_all(vector_t* v)
{
	v->num_elems = 0;
...
extern size_t vector_length(vector_t* v)
{
	return v->num_elems;
}
...
extern void vector_cmp_all(vector_t* v, void* elem, int (*cmp_func)(const void*, const void*))
{
	size_t i;
...
extern void vector_qsort(vector_t* v, int (*cmp_func)(const void*, const void*))
{
